...
class Vehicle:
    def __init__(self):
        ...
        self.end = -1
        # Add respond time
        self.respond = np.random.randint(-DELAY_RANGE, DELAY_RANGE+1)
        # crash delay
        self.delay = 0
...
def update_vehicle(vehicle_list, crossover, Time, max_speed, min_distance):
    ...
    for i in range(len(vehicle_list)-1, -1, -1):  # This loop is designed to process from back to front
        ...
        if vehicle.start != -1 and vehicle.end == -1:
            ...
            distance += vehicle.respond * vehicle.speed
            ...
            if vehicle_before and vehicle.pos > vehicle_before.pos:
                ...
                vehicle_before.acceleration = vehicle.acceleration = 0
                vehicle.delay = CRASH_TIME
...
if __name__ == "__main__":
    ...
    df.to_csv("delay_5_distance_10_crash_100_04.csv")
